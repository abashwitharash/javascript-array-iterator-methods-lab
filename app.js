...
const sortedByBirthYear = inventors.sort((young, old) =>  
    young.year - old.year)
// Complete the exercise in the space below:
...
Determine if there is at least one person in the devs array
 who is 18 years 
old or older.

- You have an array of people with their respective ages.
- Use the Array.prototype.some() method to check if any person 
in the array is 
...
Use Array.prototype.find() to identify and retrieve 
the comment object with 
...
console.log('Exercise 8 correct result: ', 
    { text: 'Super good', id: 823423 });
